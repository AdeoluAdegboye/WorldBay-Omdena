		...
		if st.sidebar.checkbox("Login"):
			...
			if result:
				...
				if task == "Select an option":
					...
					DSR = st.number_input('How many days has it been since your registration')
					f = st.number_input('What is your frequency of purchase')
					r = st.number_input('How recenct was your last purchase')
					T = st.number_input('Input the inverse of your purchase frequency')
					inc = st.number_input('What is your monthly income')
					rmod = st.number_input('recency_mod')
					fmod = st.number_input('freq_mod')
					ppp = st.number_input('on a scale of 0.1 to 0.9 what is the probability of making another purchases in the next 30 days')
					pia = st.number_input('on a scale of 0.1 to 0.9 what is the probability of having an active plan in the next 30 days')
					days = st.number_input('Input 1 in this field')
					mv = st.number_input('What is the monetary value of your requested loan')
					ce = st.number_input('What is your expected_avg_profit')					
